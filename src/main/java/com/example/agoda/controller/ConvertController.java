...
public class ConvertController {
    ...
    SseEmitter > sseEmitters = new ConcurrentHashMap <  > ();
    ...
    public ResponseEntity <  ?  > convert( @ RequestBody Map < String, Object > body) {
        ...
        Map < String,
        String > userCookies = (Map < String, String > )body.get("userCookies");
    ...
    private List < LinkInfo > sortResultsByFixedOrder(List < LinkInfo > unsortedResults, List < CidEntry > cidList) {
        // CID를 키로 하는 맵 생성
        Map < Integer,
        LinkInfo > cidToResult = unsortedResults.stream()
    ...
    private Map < String,
    String > collectSessionCookies(String url)throws Exception {
        ...
        Map < String,
        String > sessionCookies = new HashMap <  > (response.cookies());
    ...
    private LinkInfo fetchSequentiallyWithSession(String baseUrl, CidEntry entry, Map < String, String > sessionCookies) {
        ...
        Map < String,
        String > updatedCookies = updateCookiesWithNewCid(sessionCookies, entry.cid());
    ...
    private Map < String,
    String > updateCookiesWithNewCid(Map < String, String > originalCookies, int newCid) {
        Map < String,
        String > updatedCookies = new HashMap <  > (originalCookies);
